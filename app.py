...
import shutil
import atexit
from ollama_checker import OllamaStatusChecker
...
def load_settings(settings_file='settings.json'): # <--- Added default value here
    return load_json(settings_file)

# --- Load Settings ---
settings = load_settings()
# Get the FULL API URL defined in settings.json
OLLAMA_API_URL = settings.get("ollama_url", "http://localhost:11434/api/generate")
# --- NO BASE URL DERIVATION NEEDED HERE ANYMORE ---
...
# --- Perform Initial Startup Check using the FULL API URL ---
# The checker class will handle deriving the base URL internally
ollama_startup_checker = OllamaStatusChecker(OLLAMA_API_URL) # Pass the full URL
if not ollama_startup_checker.check():
    # Print the formatted message generated by the checker
    print(ollama_startup_checker.get_console_message())
else:
    # Use the checker's derived base_url for the success message
    print(f"[Startup Check] Ollama appears responsive at base URL {ollama_startup_checker.base_url}. Application starting.")
# --- End of interaction with OllamaStatusChecker ---
